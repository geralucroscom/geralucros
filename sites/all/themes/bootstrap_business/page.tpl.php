...
<?php if (($page['header_top_left'])/*So para ter utilizador autenticado->*/ && ($user->uid > 0)/* <-So para ter utilizador autenticado*/) :?>
    ...
    <div class="container">
        ...
        <div id="header-top-inside" class="clearfix">
            ...
            <div class="<?php print $header_top_left_grid_class; ?>">
                <!-- #header-top-left -->
                <div id="header-top-left" class="clearfix" style="text-align:left;">
...
<!-- header -->
<header id="header" role="banner" class="clearfix" style="width:100%;">
    <div class="container">
...
<div id="banner" class="clearfix">
    <div class="container" style="width: 100%; padding-left:0; padding-right:0; overflow:hidden;">
